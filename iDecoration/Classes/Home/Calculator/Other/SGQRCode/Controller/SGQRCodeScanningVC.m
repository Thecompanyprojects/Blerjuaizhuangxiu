...
- (void)setupNavigationBar {
    ...
    [editBtn setTitle:@"相册" forState:UIControlStateNormal];
    ...
    [editBtn addTarget:self action:@selector(rightBarButtonItenAction) forControlEvents:UIControlEventTouchUpInside];
