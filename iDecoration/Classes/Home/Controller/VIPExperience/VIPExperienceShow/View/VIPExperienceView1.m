...
@implementation VIPExperienceView1
...
-(UIImageView *)topImg
{
    if(!_topImg)
    {
        ...
        _topImg.image = [UIImage imageNamed:@"bg_renzheng"];
    }
    return _topImg;
}
...
-(UILabel *)contentlab1
{
    if(!_contentlab1)
    {
        ...
        _contentlab1.text = @"开通爱装修会员可使用更多功能";
