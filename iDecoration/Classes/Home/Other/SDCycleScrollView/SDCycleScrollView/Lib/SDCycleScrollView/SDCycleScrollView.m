...
- (void)setupMainView
{
    ...
    _ishaveMiddleImage = NO;
}

- (void)setIshaveMiddleImage:(BOOL)ishaveMiddleImage {
    _ishaveMiddleImage = ishaveMiddleImage;
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (_ishaveMiddleImage) {
        UIImageView *imageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"allpicture"]];
