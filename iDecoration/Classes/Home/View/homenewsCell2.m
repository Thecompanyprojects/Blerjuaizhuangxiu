...
{
    NSString *likedstr = [NSString stringWithFormat:@"%ld",model.likeNum];
    [self.btn2 setTitle:likedstr forState:normal];
    NSString *sharestr = [NSString stringWithFormat:@"%ld",model.share];
    [self.btn0 setTitle:sharestr forState:normal];
    NSString *commenstr = [NSString stringWithFormat:@"%ld",model.commNum];
