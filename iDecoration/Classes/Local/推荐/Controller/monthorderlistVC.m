...
@interface monthorderlistVC ()<UITableViewDataSource,UITableViewDelegate>
{
    int pagenum;
}
...
static NSString *orderlistidentfid1 = @"orderlistidentfid1";

@implementation monthorderlistVC
...
{
    orderlistCell *cell = [tableView dequeueReusableCellWithIdentifier:orderlistidentfid1];
    cell = [[orderlistCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:orderlistidentfid1];
