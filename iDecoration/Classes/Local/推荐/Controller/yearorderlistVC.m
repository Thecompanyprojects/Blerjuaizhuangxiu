...
@interface yearorderlistVC ()<UITableViewDataSource,UITableViewDelegate>
{
    int pagenum;
}
...
static NSString *orderlistidentfid0 = @"orderlistidentfid0";

@implementation yearorderlistVC
...
-(void)loadNewData
{
    ...
    NSDictionary *para = @{@"page":page,@"orderType":orderType,@"cityId":self.cityId,@"countryId":self.countryId?:@"0",@"pageSize":@"30"};
...
{
    orderlistCell *cell = [tableView dequeueReusableCellWithIdentifier:orderlistidentfid0];
    cell = [[orderlistCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:orderlistidentfid0];
