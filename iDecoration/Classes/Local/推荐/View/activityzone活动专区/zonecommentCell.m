...
@implementation zonecommentCell
...
-(void)setdata:(zonecommentModel *)model
{
    //[self.icomImg sd_setImageWithURL:[NSURL URLWithString:model.photo]];
    [self.icomImg sd_setImageWithURL:[NSURL URLWithString:model.picUrl] placeholderImage:[UIImage imageNamed:@"defaultman"]];
