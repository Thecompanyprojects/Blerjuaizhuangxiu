...
@interface addcommunityCell2()

@end


@implementation addcommunityCell2
...
-(void)setuplayout
{
    ...
    [weakSelf.commnuityText mas_makeConstraints:^(MASConstraintMaker *make) {
        make.right.equalTo(weakSelf.rightBtn.mas_left).with.offset(-12);
        make.centerY.equalTo(weakSelf);
...
-(UIButton *)rightBtn
{
    if(!_rightBtn)
    {
        ...
        [_rightBtn setImage:[UIImage imageNamed:@"shopLocation"] forState:normal];
    }
    return _rightBtn;
}
