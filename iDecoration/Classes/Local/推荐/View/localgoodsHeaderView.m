...
@implementation localgoodsHeaderView
...
-(UIButton *)chooseBtn0
{
    if(!_chooseBtn0)
    {
        ...
        [_chooseBtn0 setTitle:@"最新" forState:normal];
...
-(UIButton *)chooseBtn1
{
    if(!_chooseBtn1)
    {
        ...
        [_chooseBtn1 setTitle:@"热度" forState:normal];
...
-(UIButton *)chooseBtn2
{
    if(!_chooseBtn2)
    {
        ...
        [_chooseBtn2 setTitle:@"分类" forState:normal];
...
-(UIButton *)chooseBtn3
{
    if(!_chooseBtn3)
    {
        ...
        [_chooseBtn3 setTitle:@"价格" forState:normal];
        ...
        [_chooseBtn3 addTarget:self action:@selector(btn3click) forControlEvents:UIControlEventTouchUpInside];
        [_chooseBtn3 setImagePosition:LXMImagePositionRight spacing:9];
        [_chooseBtn3 setImage:[UIImage imageNamed:@"icon_jiagejiantou"] forState:normal];
    }
    return _chooseBtn3;
}
...
-(void)btn3click
{
    [_chooseBtn0 setTitleColor:[UIColor hexStringToColor:@"333333"] forState:normal];
    [_chooseBtn1 setTitleColor:[UIColor hexStringToColor:@"333333"] forState:normal];
    [_chooseBtn3 setTitleColor:[UIColor hexStringToColor:@"25B764"] forState:normal];
}
