//
//  ShopClassificationDetailViewController.m
//  iDecoration
//
...
@interface ShopClassificationDetailViewController ()<UICollectionViewDelegate, UICollectionViewDataSource>
@property (strong, nonatomic) WorkTypeModel *model;
@end

@implementation ShopClassificationDetailViewController
