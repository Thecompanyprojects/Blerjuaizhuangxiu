...
//@interface newWSRedPacketView ()<UIGestureRecognizerDelegate>
//#else
@interface newWSRedPacketView () <CAAnimationDelegate,UIGestureRecognizerDelegate>
//#endif

@property (nonatomic,strong) UIWindow       *alertWindow;
@property (nonatomic,strong) UIImageView    *backgroundImageView;
@property (nonatomic,strong) newWSRewardConfig *data;
...
@implementation newWSRedPacketView
...
{
    newWSRedPacketView *redPacketView = [[self alloc]initRedPackerWithData:data
                                                            cancelBlock:cancelBlock
                                                            finishBlock:finishBlock];
    return redPacketView;
}

- (instancetype)initRedPackerWithData:(newWSRewardConfig *)data
                          cancelBlock:(WSCancelBlock)cancelBlock
                          finishBlock:(WSFinishBlock)finishBlock
{
    self = [super init];
    ...
    if (self) {
        ...
        [self.avatarImageView sd_setImageWithURL:[NSURL URLWithString:data.avatarImage]];
...
- (UIImageView *)backgroundImageView
{
    if (!_backgroundImageView) {
        ...
        UIImage *image =  [UIImage imageNamed:@"bg_hongbao"];
...
- (UIButton *)openButton
{
    if (!_openButton) {
        ...
        [_openButton setImage:[UIImage imageNamed:@"icon_kaikai"] forState:UIControlStateNormal];
