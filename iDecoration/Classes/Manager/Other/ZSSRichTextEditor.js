...
//    document.getElementById('zss_editor_content').focus();
//}
...
zss_editor.insertContent = function(url,title) {
...
//        document.execCommand("insertHTML",false,"<a href='"+url+"'>"+title+"</a>");
        document.execCommand("insertHTML",false,"<p>"+title+"</p>");
    }
    zss_editor.enabledEditingItems();
...
zss_editor.selectAllText = function() {
    var text = document.getElementById('zss_editor_content');
...
zss_editor.getTEXT = function() {
    ...
    // Get the contents
    var h = document.getElementById("zss_editor_content").innerText;
    
    return h; 
}

//zss_editor.insertContent = function(title) {
//    zss_editor.restorerange();
//    var sel = document.getSelection();
//    if (sel.toString().length != 0) {
//        if (sel.rangeCount) {
