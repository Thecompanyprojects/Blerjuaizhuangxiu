...
- (void)loadAllPicture:(NSArray *)assetItem{

   
    if ([[assetItem firstObject] isKindOfClass:[PHAsset class]]) {
        
        
        PHAsset *phAsset = [assetItem firstObject];
    ...
    self.title.text = @"全部照片";
    self.subTitle.text = [NSString stringWithFormat:@"%ld",(unsigned long)assetItem.count];
