...
typedef void(^RefreshBlockcash)(void);

@interface ZCHCashCouponShowController : UITableViewController
...
@property (copy, nonatomic) RefreshBlockcash block;
