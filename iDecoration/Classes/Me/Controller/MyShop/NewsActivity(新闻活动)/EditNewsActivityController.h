...
@interface EditNewsActivityController : SNViewController

@property (nonatomic,assign) BOOL isCaogao;//是否是草稿箱
...
@property (nonatomic,copy) NSString *draftId;//草稿箱ID
