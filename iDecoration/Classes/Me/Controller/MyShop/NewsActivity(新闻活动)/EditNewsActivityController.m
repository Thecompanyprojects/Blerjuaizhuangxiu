...
@implementation EditNewsActivityController
...
-(NSString *)jsonfrom
{
    ...
    if (self.isFistr) {
        ...
        if (IsNilString(self.coverImgUrl)) {
            [[PublicTool defaultTool] publicToolsHUDStr:@"请选择封面图片" controller:self sleep:1.5];
            //return;
            return @"";
        }
        else
        ...
        if ([self.musicName isEqualToString:@"无"]) {
            self.musicName = @"";
        }
