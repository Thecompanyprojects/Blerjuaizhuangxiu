//
//  NewsActivityManageListController.m
//  iDecoration
//
//  Created by sty on 2017/12/3.
...
@interface NewsActivityManageListController ()<UITextFieldDelegate,UITableViewDelegate,UITableViewDataSource>
...
@implementation NewsActivityManageListController
...
-(void)requestData{
    ...
    NSString *defaultApi = [BASEURL stringByAppendingString:@"signUp/findSignupList.do"];
