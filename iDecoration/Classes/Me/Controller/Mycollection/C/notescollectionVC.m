...
@interface notescollectionVC ()<UITableViewDataSource,UITableViewDelegate,DZNEmptyDataSetDelegate,DZNEmptyDataSetSource>
@property (nonatomic,strong) UITableView *table;
@property (nonatomic,strong) NSMutableArray *dataSource;

@end

@implementation notescollectionVC
...
-(void)loaddata
{
    NSString *url = [BASEURL stringByAppendingString:MEIWEN_SHOUCANG];
...
{
    collectionnewsCell *cell = [tableView dequeueReusableCellWithIdentifier:@"newscell"];
    cell = [[collectionnewsCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"newscell"];
