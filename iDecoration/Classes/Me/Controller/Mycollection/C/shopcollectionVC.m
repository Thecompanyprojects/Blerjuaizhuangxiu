...
@interface shopcollectionVC ()<UITableViewDataSource,UITableViewDelegate,DZNEmptyDataSetSource,DZNEmptyDataSetDelegate>
...
-(void)loaddata
{
    NSString *url = [BASEURL stringByAppendingString:SHOP_SHOUCANG];
