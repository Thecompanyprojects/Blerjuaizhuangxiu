...
- (void)shouldCountDown {
    [ZYCTool countDownWithTime:120 AndCounting:^(NSInteger count) {
        self.enabled = NO;
        self.titleLabel.alpha = 0;
        self.overlayLabel.alpha = 1;
        self.overlayLabel.font = [UIFont systemFontOfSize:12];
        ...
        self.overlayLabel.text = [NSString stringWithFormat:@"%@ 秒后重试", @(count)];
    } AndFinished:^{
        self.enabled = YES;
