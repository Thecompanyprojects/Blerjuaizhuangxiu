...
@interface ActivityManageController : SNViewController

@property (nonatomic, copy) void(^manageBlock)(NSInteger n);//n:1 代表开通的是公司号码通vip 2:开通的是个人号码通vip;
...
// g公司logo
@property (nonatomic, copy) NSString *companLogo;
