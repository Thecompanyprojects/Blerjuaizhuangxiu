//
//  ActivityChangeAssistantTitleController.m
//  iDecoration
//
...
@interface ActivityChangeAssistantTitleController ()<UITextViewDelegate>
@property (nonatomic, strong) UITextView *textView;
@property (nonatomic, strong) UILabel *placeHolderL;
@end

@implementation ActivityChangeAssistantTitleController
    ...
    if ([lang isEqualToString:@"zh-Hans"]) {
        ...
        if (!position) {
            if (toBeString.length>kMaxLenth) {
                ...
                [[PublicTool defaultTool] publicToolsHUDStr:@"不超过40个字" controller:self sleep:1.5];
