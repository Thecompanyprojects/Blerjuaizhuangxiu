//
//  ActivityChangeMainTitleController.m
//  iDecoration
//
...
@interface ActivityChangeMainTitleController ()<UITextViewDelegate>
@property (nonatomic, strong) UITextView *textView;
@property (nonatomic, strong) UILabel *placeHolderL;
@end

@implementation ActivityChangeMainTitleController
