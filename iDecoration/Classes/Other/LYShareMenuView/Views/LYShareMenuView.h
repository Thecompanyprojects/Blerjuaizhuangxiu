...
typedef void (^JohnWallShareViewBlock)(void);
...
@property(nonatomic,copy) JohnWallShareViewBlock shareBlockDimensionCode;
@property(nonatomic,copy) JohnWallShareViewBlock shareBlockDimensionCode_S;
- (void)show;
@end
