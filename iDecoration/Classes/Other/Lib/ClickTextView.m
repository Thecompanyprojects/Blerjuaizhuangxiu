...
- (void)setUnderlineTextWithRange:(NSRange)underlineTextRange withUnderlineColor:(UIColor *)color showUnderline:(BOOL)isShow withClickCoverColor:(UIColor *)coverColor withBlock:(clickTextViewPartBlock)block {
    if (self.text.length < underlineTextRange.location+underlineTextRange.length) {
        return;
    }
