...
#define  kSuspensionViewShowNotificationCLICKName  @"SUSPENSIONVIEWSHOW_NOTIFICATIONCLICK"
...
#define kAssistiveTouchIMG          [UIImage imageNamed:@"Instruction_sus"]
#define kHeaderViewIMG              [UIImage imageNamed:@"Instruction_sus"]
#define kHeaderIMG                  [UIImage imageNamed:@"Instruction_sus"]
