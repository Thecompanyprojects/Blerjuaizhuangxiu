...
@end
@interface YPCollectionViewFlowLayout : UICollectionViewFlowLayout<UIGestureRecognizerDelegate>
...
@protocol YPCollectionViewDataSource <UICollectionViewDataSource>
...
@protocol YPCollectionViewDelegateFlowLayout <UICollectionViewDelegateFlowLayout>
@optional
