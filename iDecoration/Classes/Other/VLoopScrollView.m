...
#define AD_betweenLoopTime 3   //在此修改 图片切换间隔时间
#define AD_LoopTime 0.5 //在此修改 图片切换过程需要的时间

#define placeHolderString @"bj.png"
...
- (void)setupUI
{
    ...
    imageView_BEF.contentMode = UIViewContentModeScaleToFill;
    ...
    imageView_MID.contentMode = UIViewContentModeScaleToFill;
    ...
    imageView_AFT.contentMode = UIViewContentModeScaleToFill;
...
//    pageControl.frame = CGRectMake((scro_width - pageControl_width)/2, 100, pageControl_width, pageControl_height);
    ...
    [_pageControl mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.height.equalTo(@pageControl_height);
    }];
}
